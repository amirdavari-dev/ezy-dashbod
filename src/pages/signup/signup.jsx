                ...
                <div className="col col-lg-4 col-xl-5 bg-white">
                    <div className="px-4">
                        ...
                        <div className="col-12 text-end my-2">
                            <h5 className={` ${styled} fw-bolder `}>ثبت نام</h5>
                        </div>
                        <form onSubmit={(event) => event.preventDefault()}>
                            ...
                            <div className="row text-end gy-2">
                                <div className="col text-center">
                                    <p className={` ${styled} ${styled.ruleText}`}>با ثبت نام <span className="text-primary">شرایط و قوانین</span> زیلینک را می پذیرید.</p>
                                </div>
                            </div>
                            ...
                            <div className="row text-center">
                                <p className={styled}>
                                    حساب کاربری دارید ؟
                                    <Link to="/user" className={` ${styled} mx-1 `}>ورود</Link>
                                </p>
                            </div>
                        </form>
